...
source_data_csv_path = os.path.join(os.path.dirname(__file__), '06_psychologove.csv')
orp_csv_path = os.path.join(os.path.dirname(__file__), 'CIS0065_CS.csv')
output_data_json_path = os.path.join(os.path.dirname(__file__), '..', 'public', 'psychologists_data.json')
...
if __name__ == "__main__":
    ...
    for source_data_item in source_data:
        ...
        orp_output_data['psycholog_uvazek_na_pocet_zaku'] = orp_source_data['psycholog_uvazek_na_pocet_zaku']
